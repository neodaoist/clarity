...
contract RedeemTest is BaseUnitTestSuite {
    ...
    function testRevert_redeemCollateral_shortCall_beforeOrOnExpiry_givenUnassigned()
        public
    {
        // Given
    ...
    function test_redeemCollateral_shortCall_afterExpiry_givenUnassigned() public {
        // Given
    ...
    function testRevert_redeemCollateral_shortCall_beforeOrOnExpiry_givenPartiallyAssigned()
        public
    {
        // Given
        vm.startPrank(writer);
    ...
    function test_redeemCollateral_shortCall_afterExpiry_givenPartiallyAssigned() public {
        // Given
        uint256 wethBalance = WETHLIKE.balanceOf(writer);
        uint256 lusdBalance = LUSDLIKE.balanceOf(writer);
    ...
    function test_redeemCollateral_shortCall_beforeOrOnExpiry_givenFullyAssigned() public {
        // Given
        uint256 wethBalance = WETHLIKE.balanceOf(writer);
        uint256 lusdBalance = LUSDLIKE.balanceOf(writer);
    ...
    function test_redeemCollateral_shortCall_afterExpiry_givenFullyAssigned() public {
        // Given
        uint256 wethBalance = WETHLIKE.balanceOf(writer);
        uint256 lusdBalance = LUSDLIKE.balanceOf(writer);
    ...
    function testRevert_redeemCollateral_shortPut_beforeOrOnExpiry_givenUnassigned() public {
        // Given
        vm.startPrank(writer);
        LUSDLIKE.approve(address(clarity), scaleUpAssetAmount(LUSDLIKE, STARTING_BALANCE));
    ...
    function test_redeemCollateral_shortPut_afterExpiry_givenUnassigned() public {
        // Given
        uint256 lusdBalance = LUSDLIKE.balanceOf(writer);
        uint256 wethBalance = WETHLIKE.balanceOf(writer);
    ...
    function testRevert_redeemCollateral_shortPut_beforeOrOnExpiry_givenPartiallyAssigned()
        public
    {
        // Given
        vm.startPrank(writer);
    ...
    function test_redeemCollateral_shortPut_afterExpiry_givenPartiallyAssigned() public {
        // Given
        uint256 lusdBalance = LUSDLIKE.balanceOf(writer);
        uint256 wethBalance = WETHLIKE.balanceOf(writer);
    ...
    function test_redeemCollateral_shortPut_beforeOrOnExpiry_givenFullyAssigned() public {
        // Given
        uint256 lusdBalance = LUSDLIKE.balanceOf(writer);
        uint256 wethBalance = WETHLIKE.balanceOf(writer);
    ...
    function test_redeemCollateral_shortPut_afterExpiry_givenFullyAssigned() public {
        // Given
        uint256 lusdBalance = LUSDLIKE.balanceOf(writer);
        uint256 wethBalance = WETHLIKE.balanceOf(writer);
    ...
    function testEvent_redeemCollateral_call() public {
        // Given
        vm.startPrank(writer);
        WETHLIKE.approve(address(clarity), scaleUpAssetAmount(WETHLIKE, STARTING_BALANCE));
    ...
    function testEvent_redeemCollateral_put() public {
        // Given
        vm.startPrank(writer);
        LUSDLIKE.approve(address(clarity), scaleUpAssetAmount(LUSDLIKE, STARTING_BALANCE));
