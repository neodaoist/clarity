...
contract ExerciseSimpleBackgroundPath2Test is BaseClarityMarketsTest {
    /////////

    // Happy path, Simple background, Scenarios A-F, path 2 (assignment path 0, 2, 1)

    function test_exercise_whenSimpleA_andOneHolderExercisesLessThanTicket1_path2()
        public
        withSimpleBackground(1702e18)
    {
        ...
        assertEq(
            ...
            holder1LusdBalance - (1702e18 * 0.1),
            "holder1 LUSD balance after exercise"
        );
    }

    function test_exercise_whenSimpleB_andOneHolderExercisesEqualToTicket1_path2()
        public
        withSimpleBackground(1702e18)
    {
        ...
        assertEq(
            LUSDLIKE.balanceOf(holder1),
            holder1LusdBalance - (1702e18 * 0.15),
            "holder1 LUSD balance after exercise"
        );
    }

    function test_exercise_whenSimpleC_andOneHolderExercisesLessThanTicket2_path2()
        public
        withSimpleBackground(1702e18)
    {
        ...
        LUSDLIKE.approve(address(clarity), scaleUpAssetAmount(LUSDLIKE, STARTING_BALANCE));
        checkEvent_exercise_ShortsAssigned(writer1, oti1, 0.15e6);
        checkEvent_exercise_ShortsAssigned(writer1, oti1, 0.05e6);
        ...
        // check option balances
        assertEq(clarity.balanceOf(writer1, oti1), 0, "oti1 writer1 long balance after exercise");
        assertEq(clarity.balanceOf(writer1, oti1 + 1), 1.95e6, "oti1 writer1 short balance after exercise");
        assertEq(clarity.balanceOf(writer1, oti1 + 2), 0.2e6, "oti1 writer1 assigned balance after exercise");
        assertEq(clarity.balanceOf(writer2, oti1), 0, "oti1 writer2 long balance after exercise");
        assertEq(clarity.balanceOf(writer2, oti1 + 1), 0.35e6, "oti1 writer2 short balance after exercise");
        assertEq(clarity.balanceOf(writer2, oti1 + 2), 0, "oti1 writer2 assigned balance after exercise");
        ...
        assertEq(
            LUSDLIKE.balanceOf(holder1),
            holder1LusdBalance - (1702e18 * 0.2),
            "holder1 LUSD balance after exercise"
        );
    }

    function test_exercise_whenSimpleD_andOneHolderExercisesEqualToTicket2_path2()
        public
        withSimpleBackground(1702e18)
    {
        ...
        LUSDLIKE.approve(address(clarity), scaleUpAssetAmount(LUSDLIKE, STARTING_BALANCE));
        checkEvent_exercise_ShortsAssigned(writer1, oti1, 0.15e6);
        checkEvent_exercise_ShortsAssigned(writer1, oti1, 0.35e6);
        ...
        // check option balances
        assertEq(clarity.balanceOf(writer1, oti1), 0, "oti1 writer1 long balance after exercise");
        assertEq(clarity.balanceOf(writer1, oti1 + 1), 1.65e6, "oti1 writer1 short balance after exercise");
        assertEq(clarity.balanceOf(writer1, oti1 + 2), 0.5e6, "oti1 writer1 assigned balance after exercise");
        assertEq(clarity.balanceOf(writer2, oti1), 0, "oti1 writer2 long balance after exercise");
        assertEq(clarity.balanceOf(writer2, oti1 + 1), 0.35e6, "oti1 writer2 short balance after exercise");
        assertEq(clarity.balanceOf(writer2, oti1 + 2), 0, "oti1 writer2 assigned balance after exercise");
        ...
        assertEq(
            LUSDLIKE.balanceOf(holder1),
            holder1LusdBalance - (1702e18 * 0.5),
            "holder1 LUSD balance after exercise"
        );
    }

    function test_exercise_whenSimpleE_andOneHolderExercisesLessThanTicket3_path2()
        public
        withSimpleBackground(1702e18)
    {
        ...
        LUSDLIKE.approve(address(clarity), scaleUpAssetAmount(LUSDLIKE, STARTING_BALANCE));
        checkEvent_exercise_ShortsAssigned(writer1, oti1, 0.15e6);
        checkEvent_exercise_ShortsAssigned(writer1, oti1, 0.85e6);
        ...
        // check option balances
        assertEq(clarity.balanceOf(writer1, oti1), 0, "oti1 writer1 long balance after exercise");
        assertEq(clarity.balanceOf(writer1, oti1 + 1), 1.15e6, "oti1 writer1 short balance after exercise");
        assertEq(clarity.balanceOf(writer1, oti1 + 2), 1e6, "oti1 writer1 assigned balance after exercise");
        assertEq(clarity.balanceOf(writer2, oti1), 0, "oti1 writer2 long balance after exercise");
        assertEq(clarity.balanceOf(writer2, oti1 + 1), 0.35e6, "oti1 writer2 short balance after exercise");
        assertEq(clarity.balanceOf(writer2, oti1 + 2), 0, "oti1 writer2 assigned balance after exercise");
        ...
        assertEq(
            LUSDLIKE.balanceOf(holder1),
            holder1LusdBalance - (1702e18 * 1),
            "holder1 LUSD balance after exercise"
        );
    }

    function test_exercise_whenSimpleF_andOneHolderExercisesEqualToTicket3_path2()
        public
        withSimpleBackground(1702e18)
    {
        ...
        assertEq(
            LUSDLIKE.balanceOf(holder1),
            holder1LusdBalance - (1702e18 * 2.5),
            "holder1 LUSD balance after exercise"
        );
    }
}
