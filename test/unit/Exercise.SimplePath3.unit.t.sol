...
contract ExerciseSimpleBackgroundPath3Test is BaseClarityMarketsTest {
    /////////

    // Happy path, Simple background, Scenarios A-F, path 3 (assignment path 1, 0, 2)

    function test_exercise_whenSimpleA_andOneHolderExercisesLessThanTicket1_path3()
        public
        withSimpleBackground(1712e18)
    {
        ...
        assertEq(
            ...
            holder1LusdBalance - (1712e18 * 0.1),
            "holder1 LUSD balance after exercise"
        );
    }

    function test_exercise_whenSimpleB_andOneHolderExercisesEqualToTicket1_path3()
        public
        withSimpleBackground(1712e18)
    {
        ...
        assertEq(
            LUSDLIKE.balanceOf(holder1),
            holder1LusdBalance - (1712e18 * 0.15),
            "holder1 LUSD balance after exercise"
        );
    }

    function test_exercise_whenSimpleC_andOneHolderExercisesLessThanTicket2_path3()
        public
        withSimpleBackground(1712e18)
    {
        ...
        assertEq(
            LUSDLIKE.balanceOf(holder1),
            holder1LusdBalance - (1712e18 * 0.2),
            "holder1 LUSD balance after exercise"
        );
    }

    function test_exercise_whenSimpleD_andOneHolderExercisesEqualToTicket2_path3()
        public
        withSimpleBackground(1712e18)
    {
        ...
        assertEq(
            LUSDLIKE.balanceOf(holder1),
            holder1LusdBalance - (1712e18 * 0.5),
            "holder1 LUSD balance after exercise"
        );
    }

    function test_exercise_whenSimpleE_andOneHolderExercisesLessThanTicket3_path3()
        public
        withSimpleBackground(1712e18)
    {
        ...
        assertEq(
            LUSDLIKE.balanceOf(holder1),
            holder1LusdBalance - (1712e18 * 1),
            "holder1 LUSD balance after exercise"
        );
    }

    function test_exercise_whenSimpleF_andOneHolderExercisesEqualToTicket3_path3()
        public
        withSimpleBackground(1712e18)
    {
        ...
        assertEq(
            LUSDLIKE.balanceOf(holder1),
            holder1LusdBalance - (1712e18 * 2.5),
            "holder1 LUSD balance after exercise"
        );
    }
}
