...
interface IOptionActions {
    ...
    // function writeNewBermudanCall(address baseAsset, address quoteAsset, uint32[] calldata expiries, uint256 strike, uint64 optionAmount) external returns (uint256 optionTokenId);
