...
interface IOption {
    ...
    // max options                                  = 2^64   = 1.8e18 = ~18 trillion
    // contracts OI, bc option scalar is 6
    // max W or X asset for an option token type    = 2^64   = 1.8e18 = ~18 million units
    // notional, bc option scalar is 6
    ...
    /// @param exerciseTimestamp The first timestamp in this window on or after which the
    /// option can be exercised
    /// @param expiryTimestamp The last timestamp in this window before or on which the
    /// option can be exercised
